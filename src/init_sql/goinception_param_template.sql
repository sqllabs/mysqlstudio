...
('goinception','enable_foreign_key','true',1,'true,false','是不是支持外键','2019-05-27 15:12:59.000000','2019-05-27 15:12:59.000000'),
...
('goinception','enable_json_type','true',1,'true,false','设置是否允许json类型字段，包括建表、修改列、新增列操作','2019-05-27 15:12:59.000000','2019-05-27 15:12:59.000000'),
...
('goinception','ghost_replication_lag_query','\"\"',1,'string','检查主从复制延迟的SQL语句，默认 gh-ost 可通过 `SHOW REPLICA STATUS`（MySQL 8.0.23+）或 `SHOW SLAVE STATUS` 获取 Seconds_Behind_Master 作为主从延迟时间依据。如果使用 pt-heartbeat 工具，检查主从复制延迟的 SQL 语句类似于: `SELECT ROUND(UNIX_TIMESTAMP() - MAX(UNIX_TIMESTAMP(ts))) AS delay FROM my_schema.heartbeat`;','2019-05-27 15:25:11.000000','2019-05-27 15:25:11.000000'),
