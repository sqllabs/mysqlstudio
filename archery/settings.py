...
DATABASE_URL = get_str(
    "DATABASE_URL",
    default="mysql://root:******@127.0.0.1:3306/mysqlstudio",
)
...
REDIS_URL = get_str(
    "CACHE_URL", default="redis://:******@127.0.0.1:6379/13"
)
redis_parsed = urlparse(REDIS_URL)
redis_location = f"redis://{redis_parsed.hostname or '127.0.0.1'}:{redis_parsed.port or 6379}{redis_parsed.path or '/0'}"
